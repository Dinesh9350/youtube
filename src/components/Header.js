...
const Header = () => {
  ...
  return (
    <div className='grid grid-flow-col items-center border-b '>
      ...
      <div className='col-span-10 pl-48 flex items-center'>
        <input
          className='w-1/2 px-5 py-2 rounded-l-full border border-black'
          type='text'
          placeholder='Search'
        />
        <button className='border px-5 py-3 border-black rounded-r-full'>
          <img
